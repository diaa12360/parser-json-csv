...
class ApplicationTest {
    ...
    public void givenInvalidColumnName_whenAnyUtilityMethod_thenThrowUtilityException(){
        ...
        ArrayList<HashMap<String, String>> parsedData = parser.parse(getFilePath("sample_1.csv"));
    ...
    public void givenValidParsedData_whenGetSummation_thenReturnCorrectSummation(){
        ...
        ArrayList<HashMap<String, String>> parsedData2 = parser.parse(getFilePath("sample_2.csv"));
        ...
        ArrayList<HashMap<String, String>> parsedData3 = parser.parse(getFilePath("sample_3.csv"));
